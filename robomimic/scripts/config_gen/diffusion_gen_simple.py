...
def make_generator_helper(args):
    ...
    generator = get_generator(
        ...
        config_file=os.path.join(base_path, 'robomimic/exps/templates/diffusion_policy_simple.json'),
        args=args,
    ...
    generator.add_param(
        ...
        values_and_names=[
            ...
            # composite tasks
            # (get_robocasa_ds("ArrangeVegetables", filter_key="10_demos"), "ArrangeVegetables"),
            # (get_robocasa_ds("MicrowaveThawing", filter_key="10_demos"), "MicrowaveThawing"),
            # (get_robocasa_ds("RestockPantry", filter_key="10_demos"), "RestockPantry"),
            # (get_robocasa_ds("PreSoakPan", filter_key="10_demos"), "PreSoakPan"),
            # (get_robocasa_ds("PrepareCoffee", filter_key="10_demos"), "PrepareCoffee"),

            # attomic tasks
            (get_robocasa_ds("OpenSingleDoor", filter_key="50_demos"), "OpenSingleDoor"),
